...
for i in $(seq 0 255); do
    echo "void __attribute((cdecl)) i8259_ISR${i}();" >> $ISRS_GEN_C
done

echo "" >> $ISRS_GEN_C
echo "void i8259_ISR_Initialize()" >> $ISRS_GEN_C
echo "{" >> $ISRS_GEN_C

for i in $(seq 0 255); do
    echo "  i8259_IDT_SetGate(${i}, i8259_ISR${i}, i8259_GDT_CODE_SEGMENT, IDT_FLAG_RING0 | IDT_FLAG_GATE_32BIT_INT);" >> $ISRS_GEN_C 
