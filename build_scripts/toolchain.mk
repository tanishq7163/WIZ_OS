...
toolchain_binutils: $(TOOLCHAIN_PREFIX)/bin/i8259-elf-ld

$(TOOLCHAIN_PREFIX)/bin/i8259-elf-ld: $(BINUTILS_SRC).tar.xz
...
toolchain_gcc: $(TOOLCHAIN_PREFIX)/bin/i8259-elf-gcc

$(TOOLCHAIN_PREFIX)/bin/i8259-elf-gcc: toolchain_binutils $(GCC_SRC).tar.xz
